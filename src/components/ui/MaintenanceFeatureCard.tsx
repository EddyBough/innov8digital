...
const MaintenanceFeatureCard = ({
  ...
  return (
    <div
      className={`backdrop-blur-md bg-white/10 p-6 rounded-xl border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col items-center gap-4 h-full w-full min-h-[300px] max-h-[350px] ${className}`}
    >
